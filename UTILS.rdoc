...
WeeklyGoal.create(first_day:Date.today.at_beginning_of_week, last_day: Date.today.at_end_of_week, number: Date.today.at_beginning_of_week.strftime("%W").to_i, distance:"%2.0f"%meta.min, user_id:u.id)

end

u = User.find_by(:email => 'carumachado@gmail.com')
// Criar weeklyGoal
WeeklyGoal.create(first_day:Date.today.at_beginning_of_week, last_day: Date.today.at_end_of_week, number: Date.today.at_beginning_of_week.strftime("%W").to_i, distance:6, user_id:u.id)
...
WeeklyGoal.create(first_day:Date.today.at_beginning_of_week, last_day: Date.today.at_end_of_week, number: Date.today.at_beginning_of_week.strftime("%W").to_i, distance:8, user_id:u.id)
...
curl -X GET -H "Accept: application/json" http://localhost:3000/api/v1/users/ -v -k
...
curl -X POST -H "Accept: application/json" --data "email=pedroanisio@gmail.com&password=ironman2014" http://app.runordie.run/api/v1/sessions

2SyHaQrDMBj9EhZNKnNq

curl -X GET -H "Accept: application/json" -H "X-User-Email pedroanisio@gmail.com" -H "X-User-Token 2SyHaQrDMBj9EhZNKnNq" http://localhost:3000/api/v1/users/ -v -k
