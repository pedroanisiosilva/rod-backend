...
curl -X POST -H "Accept: application/json" -H "X-User-Email: runordieadm@gmail.com" -H "X-User-Token: -Ee48k2xe532wEJ3Uh4V"  --data "user_id=7&duration=3600&distance=10&datetime=2016-06-29T22:20:02Z" http://localhost:3000/api/v1/users/7/runs -v -k 
...
curl -X GET -H "Accept: application/json" -H "X-User-Email: runordieadm@gmail.com" -H "X-User-Token: MWvcEXT8wRqDsktxz3uU" http://localhost:3000/api/v1/users/ -v -k
